...
if [[ "$analysis" == "A45" ]]; then
	...
	" isVariant(GEN[$sample_id]) & isVariant(GEN[$sample_id]) & \
	( (AF < 0.02) & ((QUAL >= 250) | (FILTER = 'PASS')) & (GEN[$sample_id].DP[0] >= 3) & \
